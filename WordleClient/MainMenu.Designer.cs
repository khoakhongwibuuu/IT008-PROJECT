namespace WordleClient
{
    partial class MainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBoxTopic.Items.AddRange(new object[] { "random", "animals", "body", "buildings_&_places", "clothing", "colors", "cooking", "education", "electronics", "emotions", "entertainment", "food", "government_&_law", "health", "hobbies", "home", "money_&_banking", "nature", "people_&_relationships", "plants_&_gardening", "school", "science", "shopping", "sports", "technology", "time_&_dates", "tools", "transport", "travel", "weather", "work" });
